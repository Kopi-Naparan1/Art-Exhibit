...
export default function CTASection({ title, description, href, label }) {
  return (
    <section className="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 md:px-8 md:py-12">
      <div className="rounded-[34px] border border-[var(--border)] bg-[var(--surface-alt)] px-6 py-10 text-center shadow-[0_10px_26px_rgba(43,43,43,0.05)] md:px-10 md:py-14">
        <p className="mx-auto mb-3 inline-flex items-center rounded-full border border-[rgba(203,160,90,0.38)] bg-[rgba(203,160,90,0.12)] px-3 py-1 text-xs tracking-[0.28em] text-[var(--gold)] uppercase">
          Final Reflection
        </p>
