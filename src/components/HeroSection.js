...
export default function HeroSection({
  ...
  return (
    <section className="mx-auto w-full max-w-7xl px-4 py-6 sm:px-6 sm:py-8 lg:px-8 lg:py-16">
      <div className="grid items-center gap-8 rounded-4xl border border-[var(--border)] bg-[var(--paper)] p-4 shadow-[0_16px_40px_var(--ink-shadow)] sm:gap-10 sm:p-6 lg:grid-cols-[1.05fr_0.95fr] lg:gap-12 lg:p-10">
        ...
        <div className="order-2 grid gap-4 sm:grid-cols-[1.1fr_0.9fr] lg:order-none">
          <div className="relative aspect-[4/5] overflow-hidden rounded-[28px] border border-[var(--border)] bg-[var(--surface-alt)] sm:aspect-[4/4.6] lg:min-h-[420px]">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[rgba(60,45,34,0.24)] via-transparent to-transparent" />
          </div>
